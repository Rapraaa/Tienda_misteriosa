...
urlpatterns = [
    ...
    path(
        "producto/editar/<int:pk>", ProductoUpdateView.as_view(), name="editar_producto"
    ),  # EN MIXINS ES PK NO ID
    ...
    path(
        "categorias/toggle/<int:pk>/", categoria_toggle_activa, name="toggle_categoria"
    ),
    ...
    path(
        "carrito/compra-exitosa/", compra_exitosa_carrito, name="compra_exitosa_carrito"
    ),
    # Cupones
    ...
    path(
        "cupones/<int:pk>/eliminar/", CuponDeleteView.as_view(), name="cupon_eliminar"
    ),
    ...
    path(
        "gestion/usuarios/<int:pk>/editar/",
        UserUpdateView.as_view(),
        name="admin_users_edit",
    ),
    path(
        "gestion/usuarios/<int:pk>/historial/",
